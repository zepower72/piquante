...
// Middleware images
const storage = multer.diskStorage({ //diskStorage() pour indiquer à multer où enregistrer les fichiers entrants
  destination: (req, file, callback) => { //destination() pour indiquer à multer d'enregistrer les fichiers dans le dossier images
